 ...
 */
export default function Button({ onClick, children, variant = "primary", iconRight, iconLeft }: ButtonProps) {
    ...
    return (
        <div className='bg-characters dark:bg-dark-characters w-auto rounded-xl'>
